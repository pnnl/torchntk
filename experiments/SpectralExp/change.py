...
gamma1 = 1.2 # gamma1 = d/n
gamma2 = 1.5 # gamma2 = h/n
...
ax2.title.set_text('Sigmoid activation, lr=%g'% eta)
ax2.legend()
...
fig.savefig('sigmoid_weight_%g_%g.png'% (gamma1,gamma2))
...
fig.tight_layout(pad=1.5)
fig.savefig('sigmoid_ck_ntk_difference_%g_%g.png'% (gamma1,gamma2))

np.save('sigmoid_NN_history_%g_%g.npy' % (gamma1,gamma2),NN_loss)
np.save('sigmoid_spectra_history_%g_%g.npy' % (gamma1,gamma2),NN_weight_diff)
